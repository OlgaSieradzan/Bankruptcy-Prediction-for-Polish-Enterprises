...
setwd("C:/Users/olgas/OneDrive/Documents/GitHub/Quantative-risk-models-summit/Altman-model_files/5year.arff")
```
...
cat("False negative rate: ", 100*tab[1,2]/(tab[1,1]+tab[1,2]), "%\n")
```  
